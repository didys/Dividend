...
/* Dividend GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Dividend"
#define QAPP_ORG_DOMAIN "dividend.io"
#define QAPP_APP_NAME_DEFAULT "Dividend-Qt"
#define QAPP_APP_NAME_TESTNET "Dividend-Qt-testnet"
