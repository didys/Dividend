...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zdevTracker->HasMintTx(hash))) {
            //zDVD stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZDVD;
...
bool IsZDVDType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZDVD:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZDVD || type == TransactionRecord::MNReward) {
