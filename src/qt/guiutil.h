...
/** Utility functions used by the Dividend Qt UI.
 */
namespace GUIUtil
{
...
// Render Dividend addresses in monospace font
...
// Parse "dividend:" URI into recipient object, return true on successful parsing
