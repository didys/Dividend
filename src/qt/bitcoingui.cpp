                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Dividend Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Dividend address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dividend: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDVD"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Dividend Core"), this);
    aboutAction->setStatusTip(tr("Show information about Dividend Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Dividend"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Dividend addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Dividend addresses"));
    ...
    openAction->setStatusTip(tr("Open a Dividend: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Dividend Core help message to get a list with possible Dividend command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Dividend Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Dividend network", "", count));
}
...
{
    QString strTitle = tr("Dividend Core"); // default title
