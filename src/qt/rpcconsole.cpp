                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzDVDPathCustom = GetArg("-zdevbackuppath", "");
    ...
    if(!strzDVDPathCustom.empty()) {
        ui->wallet_customzdevbackuppath->setText(QString::fromStdString(strzDVDPathCustom));
        ui->wallet_customzdevbackuppath_label->setVisible(true);
        ui->wallet_customzdevbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzDVDPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Dividend RPC console.") + "<br>" +
