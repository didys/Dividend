...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Dividend Core"),
     ...
     * override -datadir in the dividend.conf file in the default data directory
     * (to be consistent with dividendd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
