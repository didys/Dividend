...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 59918;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Dividend starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Dividend: 1 day
        nTargetSpacing = 1 * 60;  // Dividend: 1 minute
        nMaturity = 10;
         ...
         */
         ...
         genesis.nVersion = 1;
         genesis.nTime = 1531356000;
         genesis.nBits = 0x1e0ffff0;
         genesis.nNonce = 409803;

         hashGenesisBlock = genesis.GetHash();
         assert(hashGenesisBlock == uint256("0000085f6412844c97905b3192cd3238822c3cbeed97ae7556a09a80b4973113"));
         assert(genesis.hashMerkleRoot == uint256("ea032875c70b2780555d385b8effdd961afd903c1b87721b5f962c77cab3f90a"));

        vSeeds.push_back(CDNSSeedData("dividendcashasia.ddns.net", "dividendcashasia.ddns.net"));     // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("dividendcasheurope.ddns.net", "dividendcasheurope.ddns.net"));    // Secondary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("dividendcashusa.ddns.net", "dividendcashusa.ddns.net"));
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "dividend-testnet.seed.fuzzbawls.pw"));
        //vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "dividend-testnet.seed2.fuzzbawls.pw"));
        //vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net"));
        //vSeeds.push_back(CDNSSeedData("192.168.100.2", "192.168.100.2"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 129); // Testnet dividend addresses start with 't' or 'u'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 14);  // Testnet dividend script addresses start with '6' or '7'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet dividend BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x2a)(0x40)(0x71)(0xb0).convert_to_container<std::vector<unsigned char> >();
        // Testnet dividend BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x2a)(0x40)(0x78)(0x47).convert_to_container<std::vector<unsigned char> >();
        // Testnet dividend BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Dividend: 1 day
        nTargetSpacing = 1 * 60;        // Dividend: 1 minutes
