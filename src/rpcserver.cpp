...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Dividend server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Dividend server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Dividend features */
        {"dividend", "masternode", &masternode, true, true, false},
        {"dividend", "listmasternodes", &listmasternodes, true, true, false},
        {"dividend", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dividend", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dividend", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"dividend", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"dividend", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"dividend", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dividend", "masternodedebug", &masternodedebug, true, true, false},
        {"dividend", "startmasternode", &startmasternode, true, true, false},
        {"dividend", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dividend", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dividend", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dividend", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dividend", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dividend", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dividend", "mnbudget", &mnbudget, true, true, false},
        {"dividend", "preparebudget", &preparebudget, true, true, false},
        {"dividend", "submitbudget", &submitbudget, true, true, false},
        {"dividend", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dividend", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dividend", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dividend", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dividend", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dividend", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dividend", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dividend", "checkbudgets", &checkbudgets, true, true, false},
        {"dividend", "mnsync", &mnsync, true, true, false},
        {"dividend", "spork", &spork, true, true, false},
        {"dividend", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> dividend-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:59917/\n";
}
